...
class DuckCloudClient:
    """Client for the DuckCloud REST API with auth, retry, and token refresh."""
    ...
    async def __aenter__(self) -> "DuckCloudClient":
        return self
    ...
    async def authenticate(self) -> None:
        ...
        try:
            ...
            raise DuckCloudError(str(exc)) from exc
